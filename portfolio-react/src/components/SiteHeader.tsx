...
export function SiteHeader({ brandName, navigationItems }: SiteHeaderProps) {
  return (
    <header className="mx-auto flex w-[min(1180px,calc(100%-48px))] items-center justify-between py-[26px] pb-[18px] max-[720px]:w-[min(100%-32px,1180px)] max-[720px]:flex-col max-[720px]:items-start max-[720px]:gap-4">
      <a className="inline-flex items-center gap-3.5 font-bold" href="#top" aria-label={`${brandName} home`}>
        <span className="grid size-11 place-items-center rounded-[10px] border border-blue-600/45 font-extrabold tracking-[-0.06em] text-blue-700">
          MA
        </span>
