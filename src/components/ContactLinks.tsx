...
const brandIconPaths: Partial<Record<ContactIconName, string>> = {
  github:
    'M12 .5A11.5 11.5 0 0 0 .5 12.28c0 5.2 3.34 9.6 7.98 11.16.58.11.79-.26.79-.57 0-.28-.01-1.03-.02-2.02-3.25.72-3.93-1.6-3.93-1.6-.53-1.38-1.3-1.75-1.3-1.75-1.06-.74.08-.73.08-.73 1.17.09 1.79 1.23 1.79 1.23 1.04 1.83 2.74 1.3 3.4.99.11-.78.41-1.3.74-1.6-2.6-.3-5.32-1.33-5.32-5.91 0-1.31.46-2.38 1.2-3.22-.12-.3-.52-1.52.12-3.17 0 0 .98-.32 3.21 1.23a10.9 10.9 0 0 1 5.84 0c2.23-1.55 3.21-1.23 3.21-1.23.64 1.65.24 2.87.12 3.17.75.84 1.91 1.2 3.22 1.2 3.22 0 4.6-2.73 5.6-5.33 5.9.42.38.79 1.1.79 2.22 0 1.6-.01 2.89-.01 3.28 0 .32.21.69.8.57A11.53 11.53 0 0 0 23.5 12.28 11.5 11.5 0 0 0 12 .5Z',
  linkedin:
